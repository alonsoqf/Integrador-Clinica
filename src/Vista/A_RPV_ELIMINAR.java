 ...
 * @author PC
 */
public class A_RPV_ELIMINAR extends javax.swing.JDialog {
     ...
     */
    public A_RPV_ELIMINAR(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CÓDIGO PROVEEDOR");
    ...
    private void txtBDNIKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBDNIKeyReleased
        ...
        if (texto.trim().length() == 0) {
            ...
            sorter.setRowFilter(RowFilter.regexFilter("(?i)" + texto, 2)); // Filtra por la columna "DNI/PASAPORTE" (índice 4)
        }
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        ...
        int selectedRowView = tblProveedor.getSelectedRow();
        ...
        int selectedRowModel = tblProveedor.convertRowIndexToModel(selectedRowView);

        // Obtener los datos del doctor de la fila seleccionada
        DefaultTableModel modelo = (DefaultTableModel) tblProveedor.getModel();
        String idProveedor = (String) modelo.getValueAt(selectedRowModel, 0);
        String codigo = (String) modelo.getValueAt(selectedRowModel, 1);
        String empresa = (String) modelo.getValueAt(selectedRowModel, 2);
        String ruc = (String) modelo.getValueAt(selectedRowModel, 3);
        String telefono = (String) modelo.getValueAt(selectedRowModel, 4);
        String correo = (String) modelo.getValueAt(selectedRowModel, 5);

        // Crear el mensaje de confirmación con los detalles del doctor
        String mensaje = "¿Estás seguro de que deseas eliminar el siguiente proveedor?\n\n"
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                String deleteSQL = "DELETE FROM registro_proveedor WHERE id = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A_RPV_ELIMINAR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                A_RPV_ELIMINAR dialog = new A_RPV_ELIMINAR(new javax.swing.JFrame(), true);
